...
class ResponseSuccessTemplate(BaseModel):
    """
    ...
    body: Optional[StrictStr] = Field(None, description="HTML body of the template")
    css: Optional[StrictStr] = Field(None, description="CSS of the template")
    settings: Optional[StrictStr] = Field(None, description="Print settings of the template")
    __properties = ["status", "template_id", "body", "css", "settings"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResponseSuccessTemplate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResponseSuccessTemplate:
        """Create an instance of ResponseSuccessTemplate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResponseSuccessTemplate.parse_obj(obj)

        _obj = ResponseSuccessTemplate.parse_obj({
