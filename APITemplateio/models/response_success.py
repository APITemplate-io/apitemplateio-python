...
class ResponseSuccess(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResponseSuccess:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResponseSuccess:
        """Create an instance of ResponseSuccess from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResponseSuccess.parse_obj(obj)

        _obj = ResponseSuccess.parse_obj({
