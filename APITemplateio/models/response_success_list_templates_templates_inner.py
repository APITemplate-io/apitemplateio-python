...
class ResponseSuccessListTemplatesTemplatesInner(BaseModel):
    """
    ...
    __properties = ["template_id", "name", "status", "format", "created_at", "updated_at", "group_name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResponseSuccessListTemplatesTemplatesInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResponseSuccessListTemplatesTemplatesInner:
        """Create an instance of ResponseSuccessListTemplatesTemplatesInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResponseSuccessListTemplatesTemplatesInner.parse_obj(obj)

        _obj = ResponseSuccessListTemplatesTemplatesInner.parse_obj({
