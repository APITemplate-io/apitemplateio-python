...
class ResponseSuccessImageFile(BaseModel):
    """
    ...
    download_url_png: Optional[StrictStr] = Field(None, description="Download URL PNG")
    ...
    __properties = ["status", "download_url", "download_url_png", "template_id", "transaction_ref", "post_actions"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResponseSuccessImageFile:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResponseSuccessImageFile:
        """Create an instance of ResponseSuccessImageFile from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResponseSuccessImageFile.parse_obj(obj)

        _obj = ResponseSuccessImageFile.parse_obj({
            "status": obj.get("status"),
            "download_url": obj.get("download_url"),
            "download_url_png": obj.get("download_url_png"),
