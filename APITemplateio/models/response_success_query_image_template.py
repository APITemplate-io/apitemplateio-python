...
class ResponseSuccessQueryImageTemplate(BaseModel):
    """
    ResponseSuccessQueryImageTemplate
    """
    status: Optional[StrictStr] = Field(None, description="Status")
    width: Optional[StrictInt] = Field(None, description="Width")
    height: Optional[StrictInt] = Field(None, description="Height")
    layers: Optional[conlist(Dict[str, Any])] = Field(None, description="Array of layers")
    __properties = ["status", "width", "height", "layers"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResponseSuccessQueryImageTemplate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResponseSuccessQueryImageTemplate:
        """Create an instance of ResponseSuccessQueryImageTemplate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResponseSuccessQueryImageTemplate.parse_obj(obj)

        _obj = ResponseSuccessQueryImageTemplate.parse_obj({
