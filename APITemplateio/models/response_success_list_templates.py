...
class ResponseSuccessListTemplates(BaseModel):
    """
    ResponseSuccessListTemplates
    """
    status: Optional[StrictStr] = None
    templates: Optional[conlist(ResponseSuccessListTemplatesTemplatesInner)] = None
    __properties = ["status", "templates"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResponseSuccessListTemplates:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResponseSuccessListTemplates:
        """Create an instance of ResponseSuccessListTemplates from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResponseSuccessListTemplates.parse_obj(obj)

        _obj = ResponseSuccessListTemplates.parse_obj({
            "status": obj.get("status"),
            "templates": [ResponseSuccessListTemplatesTemplatesInner.from_dict(_item) for _item in obj.get("templates")] if obj.get("templates") is not None else None
        })
        return _obj
