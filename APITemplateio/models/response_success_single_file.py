...
class ResponseSuccessSingleFile(BaseModel):
    """
    ResponseSuccessSingleFile
    """
    status: Optional[StrictStr] = Field(None, description="Status")
    primary_url: Optional[StrictStr] = Field(None, description="Generated PDF document")
    ...
    __properties = ["status", "primary_url", "total_pages", "transaction_ref"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResponseSuccessSingleFile:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResponseSuccessSingleFile:
        """Create an instance of ResponseSuccessSingleFile from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResponseSuccessSingleFile.parse_obj(obj)

        _obj = ResponseSuccessSingleFile.parse_obj({
