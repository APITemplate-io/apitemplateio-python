...
class UpdateTemplateRequest(BaseModel):
    ...
    """
    template_id: StrictStr = Field(..., description="Your template id, it can be obtained in the web console(Manage Templates) ")
    body: Optional[StrictStr] = Field(None, description="The HTML body ")
    css: Optional[StrictStr] = Field(None, description="The css ")
    __properties = ["template_id", "body", "css"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateTemplateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateTemplateRequest:
        """Create an instance of UpdateTemplateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateTemplateRequest.parse_obj(obj)

        _obj = UpdateTemplateRequest.parse_obj({
