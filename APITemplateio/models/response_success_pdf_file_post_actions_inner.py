...
class ResponseSuccessPDFFilePostActionsInner(BaseModel):
    """
    ...
    __properties = ["action", "name", "bucket", "status", "file"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResponseSuccessPDFFilePostActionsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResponseSuccessPDFFilePostActionsInner:
        """Create an instance of ResponseSuccessPDFFilePostActionsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResponseSuccessPDFFilePostActionsInner.parse_obj(obj)

        _obj = ResponseSuccessPDFFilePostActionsInner.parse_obj({
