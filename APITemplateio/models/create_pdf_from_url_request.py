...
class CreatePdfFromUrlRequest(BaseModel):
    """
    CreatePdfFromUrlRequest
    """
    url: Optional[StrictStr] = Field(None, description="The URL ")
    settings: Optional[PDFGenerationSettingsObject] = None
    __properties = ["url", "settings"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreatePdfFromUrlRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreatePdfFromUrlRequest:
        """Create an instance of CreatePdfFromUrlRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreatePdfFromUrlRequest.parse_obj(obj)

        _obj = CreatePdfFromUrlRequest.parse_obj({
            "url": obj.get("url"),
