...
class ResponseSuccessListObjects(BaseModel):
    """
    ResponseSuccessListObjects
    """
    status: Optional[StrictStr] = None
    objects: Optional[List[object]] = None
    __properties = ["status", "objects"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResponseSuccessListObjects:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResponseSuccessListObjects:
        """Create an instance of ResponseSuccessListObjects from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResponseSuccessListObjects.parse_obj(obj)

        _obj = ResponseSuccessListObjects.parse_obj({
