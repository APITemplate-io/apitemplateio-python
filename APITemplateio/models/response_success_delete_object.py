...
class ResponseSuccessDeleteObject(BaseModel):
    """
    ResponseSuccessDeleteObject
    """
    status: Optional[StrictStr] = None
    transaction_ref: Optional[Any] = None
    __properties = ["status", "transaction_ref"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResponseSuccessDeleteObject:
    ...
    def to_dict(self):
        ...
        if self.transaction_ref is None and "transaction_ref" in self.__fields_set__:
            _dict['transaction_ref'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> ResponseSuccessDeleteObject:
        """Create an instance of ResponseSuccessDeleteObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResponseSuccessDeleteObject.parse_obj(obj)

        _obj = ResponseSuccessDeleteObject.parse_obj({
