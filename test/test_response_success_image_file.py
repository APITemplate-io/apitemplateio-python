...
from APITemplateio.models.response_success_image_file import ResponseSuccessImageFile  # noqa: E501
from APITemplateio.rest import ApiException

class TestResponseSuccessImageFile(unittest.TestCase):
    """ResponseSuccessImageFile unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ResponseSuccessImageFile
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResponseSuccessImageFile`
        """
        model = APITemplateio.models.response_success_image_file.ResponseSuccessImageFile()  # noqa: E501
        if include_optional :
            return ResponseSuccessImageFile(
                ...
                post_actions = [{"action":"S3","name":"S3 Storage","bucket":"alphacloud-test-bucket","status":"success","file":"s3://alphacloud-test-bucket/91f62769-69e4-48bf.png"},{"action":"S3","name":"S3 Storage","bucket":"alphacloud-test-bucket","status":"success","file":"s3://alphacloud-test-bucket/91f62769-69e4-48bf.jpg"}]
            )
        else :
            return ResponseSuccessImageFile(
        )
    ...
    def testResponseSuccessImageFile(self):
        """Test ResponseSuccessImageFile"""
