...
from APITemplateio.models.create_pdf_from_html_request import CreatePdfFromHtmlRequest  # noqa: E501
from APITemplateio.rest import ApiException

class TestCreatePdfFromHtmlRequest(unittest.TestCase):
    """CreatePdfFromHtmlRequest unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CreatePdfFromHtmlRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreatePdfFromHtmlRequest`
        """
        model = APITemplateio.models.create_pdf_from_html_request.CreatePdfFromHtmlRequest()  # noqa: E501
        if include_optional :
            return CreatePdfFromHtmlRequest(
                body = '"<h1> hello world {{name}} </h1>"
', 
                css = '"<style>.bg{backgound: red};</style>"
', 
                data = name: "This is a title"
, 
    ...
    def testCreatePdfFromHtmlRequest(self):
        """Test CreatePdfFromHtmlRequest"""
