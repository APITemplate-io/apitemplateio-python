...
from APITemplateio.models.response_success_query_image_template import ResponseSuccessQueryImageTemplate  # noqa: E501
from APITemplateio.rest import ApiException

class TestResponseSuccessQueryImageTemplate(unittest.TestCase):
    """ResponseSuccessQueryImageTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ResponseSuccessQueryImageTemplate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResponseSuccessQueryImageTemplate`
        """
        model = APITemplateio.models.response_success_query_image_template.ResponseSuccessQueryImageTemplate()  # noqa: E501
        if include_optional :
            return ResponseSuccessQueryImageTemplate(
                status = 'success', 
                width = 1024, 
                height = 1024, 
                layers = [
...
},
{
    ...
    def testResponseSuccessQueryImageTemplate(self):
        """Test ResponseSuccessQueryImageTemplate"""
