...
from APITemplateio.models.pdf_generation_settings_object import PDFGenerationSettingsObject  # noqa: E501
from APITemplateio.rest import ApiException

class TestPDFGenerationSettingsObject(unittest.TestCase):
    """PDFGenerationSettingsObject unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test PDFGenerationSettingsObject
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PDFGenerationSettingsObject`
        """
        model = APITemplateio.models.pdf_generation_settings_object.PDFGenerationSettingsObject()  # noqa: E501
        if include_optional :
            return PDFGenerationSettingsObject(
                paper_size = '', 
                custom_width = '', 
                custom_height = '', 
                orientation = '', 
    ...
    def testPDFGenerationSettingsObject(self):
        """Test PDFGenerationSettingsObject"""
