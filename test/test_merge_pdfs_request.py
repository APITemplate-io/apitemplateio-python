...
from APITemplateio.models.merge_pdfs_request import MergePdfsRequest  # noqa: E501
from APITemplateio.rest import ApiException

class TestMergePdfsRequest(unittest.TestCase):
    """MergePdfsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test MergePdfsRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MergePdfsRequest`
        """
        model = APITemplateio.models.merge_pdfs_request.MergePdfsRequest()  # noqa: E501
        if include_optional :
            return MergePdfsRequest(
                urls = ["https://fileserver.com/a1.pdf","https://fileserver.com/b2.pdf","data:application/pdf;base64,JVBERi0xLjIg...[truncated]"], 
                export_type = 'json', 
                expiration = 5, 
                cloud_storage = 1
            )
