...
from APITemplateio.models.response_success_list_templates_templates_inner import ResponseSuccessListTemplatesTemplatesInner  # noqa: E501
from APITemplateio.rest import ApiException

class TestResponseSuccessListTemplatesTemplatesInner(unittest.TestCase):
    """ResponseSuccessListTemplatesTemplatesInner unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ResponseSuccessListTemplatesTemplatesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResponseSuccessListTemplatesTemplatesInner`
        """
        model = APITemplateio.models.response_success_list_templates_templates_inner.ResponseSuccessListTemplatesTemplatesInner()  # noqa: E501
        if include_optional :
            return ResponseSuccessListTemplatesTemplatesInner(
                template_id = '', 
                name = '', 
                status = '', 
                format = '', 
    ...
    def testResponseSuccessListTemplatesTemplatesInner(self):
        """Test ResponseSuccessListTemplatesTemplatesInner"""
