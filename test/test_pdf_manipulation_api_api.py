...
from APITemplateio.api.pdf_manipulation_api_api import PDFManipulationAPIApi  # noqa: E501
from APITemplateio.rest import ApiException


class TestPDFManipulationAPIApi(unittest.TestCase):
    """PDFManipulationAPIApi unit test stubs"""

    def setUp(self):
        self.api = APITemplateio.api.pdf_manipulation_api_api.PDFManipulationAPIApi()  # noqa: E501
