...
from APITemplateio.models.response_success_pdf_file_post_actions_inner import ResponseSuccessPDFFilePostActionsInner  # noqa: E501
from APITemplateio.rest import ApiException

class TestResponseSuccessPDFFilePostActionsInner(unittest.TestCase):
    """ResponseSuccessPDFFilePostActionsInner unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ResponseSuccessPDFFilePostActionsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ResponseSuccessPDFFilePostActionsInner`
        """
        model = APITemplateio.models.response_success_pdf_file_post_actions_inner.ResponseSuccessPDFFilePostActionsInner()  # noqa: E501
        if include_optional :
            return ResponseSuccessPDFFilePostActionsInner(
                action = '', 
                name = '', 
                bucket = '', 
                status = '', 
    ...
    def testResponseSuccessPDFFilePostActionsInner(self):
        """Test ResponseSuccessPDFFilePostActionsInner"""
